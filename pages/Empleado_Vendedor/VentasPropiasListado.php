...
<body class="p-8">
    ...
    <tr>
        ...
        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Condición</th> 
    ...
    <?php foreach ($listado_ventas as $venta): ?>
        <tr>
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                <?= htmlspecialchars($venta['idVenta']) ?>
            </td>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <?= htmlspecialchars($venta['Nombre_Cliente']) ?> <?= htmlspecialchars($venta['Apellido1_Cliente']) ?>
            </td>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <?= htmlspecialchars($venta['Condicion_Automovil']) ?>
            </td>

            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <?= htmlspecialchars($venta['Tipo_Vehiculo']) ?>
            </td>
